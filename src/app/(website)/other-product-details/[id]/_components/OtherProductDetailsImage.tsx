...
//   alt: string;
// }
// const OtherProductDetailsImage: React.FC = () => {
...
//             <Button
//               variant="outline"
//               className="flex-1 border-red-600 text-red-600 hover:bg-gray-50 font-medium py-3 px-6 rounded-md transition-colors duration-200"
//               size="lg"
//             >
//               Add to Cart
//             </Button>
...
// export default OtherProductDetailsImage;
...
const OtherProductDetailsImage: React.FC<ProductDetailsImageProps> = ({
  productId,
}) => {
  const [selectedImage, setSelectedImage] = useState<number>(0);
  ...
  <Button
    ...
    className="w-full h-[51px] border border-red-600 text-red-600 hover:bg-red-600 hover:text-white text-lg font-semibold transition-transform hover:scale-105"
  >
    Add to Cart
  </Button>
</div>
