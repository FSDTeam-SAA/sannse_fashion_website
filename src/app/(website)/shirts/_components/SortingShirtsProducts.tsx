...
import productImage from "@/Public/images/shirtPrduct.png";
import { StaticImageData } from "next/image";
import ShowShirtsProducts from "./ShowShirtsProducts";
    ...
    <div className="lg:container lg:mx-auto p-4 w-full">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full">
          <ShowShirtsProducts products={products} />
        </div>
      </div>
    </div>
  );
...
export default SortingShirtsProducts;
